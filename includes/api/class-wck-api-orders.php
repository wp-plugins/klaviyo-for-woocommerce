<?php
/**
 * WooCommerceKlaviyo API Orders Class
 *
...
class WCK_API_Orders extends WCK_API_Resource {
	...
	public function register_routes( $routes ) {
		...
		$routes[ $this->base ] = array(
			array( array( $this, 'get_orders' ),     WCK_API_Server::READABLE ),
		);

		# GET /orders/count
		$routes[ $this->base . '/count'] = array(
			array( array( $this, 'get_orders_count' ), WCK_API_Server::READABLE ),
		);

		# GET|PUT /orders/<id>
		$routes[ $this->base . '/(?P<id>\d+)' ] = array(
			array( array( $this, 'get_order' ),  WCK_API_Server::READABLE ),
			array( array( $this, 'edit_order' ), WCK_API_Server::EDITABLE | WCK_API_Server::ACCEPT_DATA ),
		);

		# GET /orders/<id>/notes
		$routes[ $this->base . '/(?P<id>\d+)/notes' ] = array(
			array( array( $this, 'get_order_notes' ), WCK_API_Server::READABLE ),
		);
	...
	public function get_order( $id, $fields = null ) {
		...
		return array( 'order' => apply_filters( 'woocommerce_klaviyo_api_order_response', $order_data, $order, $fields, $this->server ) );
	}
	...
	public function get_orders_count( $status = null, $filter = array() ) {
		...
		if ( ! current_user_can( 'read_private_shop_orders' ) )
			return new WP_Error( 'woocommerce_klaviyo_api_user_cannot_read_orders_count', __( 'You do not have permission to read the orders count', 'woocommerce-klaviyo' ), array( 'status' => 401 ) );
	...
	public function get_order_notes( $id, $fields = null ) {
		...
		return array( 'order_notes' => apply_filters( 'woocommerce_klaviyo_api_order_notes_response', $order_notes, $id, $fields, $notes, $this->server ) );
	}
